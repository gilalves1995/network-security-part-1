...
import stgc.tlp.STGCMulticastSocket;
...
public class MulticastChat extends Thread {
  ...
  public MulticastChat(String username, InetAddress group, int port, 
                       int ttl, 
                       MulticastChatEventListener listener, STGCProtocol stgc) throws IOException {
    ...
    msocket = new STGCMulticastSocket(port, stgc, username);
